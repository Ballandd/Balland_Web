  ...
  return (
    <div className = "grid justify-items-center">
      ...
      <div className = "divide-y-2 divide-solid divide-black">
            <h2 className = " mt-5 ml-[35px] mr-[35px] left-9 top-5 font-mono text-left text-[20px] font-bold">예약하기</h2>
            <div className = "mt-5 ml-[35px] mr-[35px]">
              <div className = "flex flex-row mt-[10px]">
                <div className = "w-[53px] self-center">
                  <label className="block text-gray-700 text-[13px] font-bold" for="username">
                  신청자명
                  </label>
                </div>
              ...
              <div className = "flex flex-row mt-[10px]">
                <div className = "w-[53px] self-center">
                  <label className="block text-gray-700 text-[13px] font-bold" for="phonenumber">
                  연락처
                  </label>
                </div>
                <div className = "ml-[47px]">
              ...
              <div className = "flex flex-row mt-[10px]">
                <div className = "w-[53px] self-center">
                  <label className="block text-gray-700 text-[13px] font-bold" for="email">
                  이메일
                  </label>
                </div>
                <div className = "ml-[47px]">
              ...
              <div className = "flex flex-row mt-[10px]">
                <div className = "w-[53px] self-center">
                  <label className="block text-gray-700 text-[13px] font-bold" for="studentid">
                  학번
                  </label>
                </div>
                <div className = "ml-[47px]">
      ...
      <div className = "divide-y-2 divide-solid divide-black">
            <h2 className = " mt-5 ml-[35px] mr-[35px] left-9 top-5 font-mono text-left text-[20px] font-bold">사용목적</h2>
            <div className = "mt-5 ml-[35px] mr-[35px]">
              <div className = "flex flex-row mt-[10px]">
                <div className = "w-[53px] self-center">
                  <label className="block text-gray-700 text-[13px] font-bold" for="totalnumber">
                  인원
                  </label>
                </div>
                <div className = "ml-[47px]">
                  <input {...register('totalnumber',{required : true})} 
                  className="shadow appearance-none border rounded w-[400px] h-[34px] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " 
                  id="totalnumber" 
                  type="text" 
              ...
              <div className = "flex flex-row mt-[10px]">
                <div className = "w-[53px] self-center">
                  <label className="block text-gray-700 text-[13px] font-bold" for="purpose">
                  사용목적
                  </label>
                </div>
                <div className = "ml-[47px]">
              ...
              <div className = "flex flex-row mt-[10px]">
                <div className = "w-[53px] self-center">
                  <label className="block text-gray-700 text-[13px] font-bold" for="content">
                  행사내용
                  </label>
                </div>
                <div className = "ml-[47px]">
              ...
              <div className = "flex flex-row mt-[10px]">
                <div className = "w-[53px]">
                  <label className="block text-gray-700 text-[13px] font-bold" for="etc">
                  기타사항
                  </label>
                </div>
                <div className = "ml-[47px]">
