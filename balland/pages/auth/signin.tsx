    ...
    <div className = "h-screen">
      ...
      <form onSubmit={handleSubmit(login)}>
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="w-11/12 s:w-10/12 lg:w-8/12 bg-white rounded-lg shadow dark:border">
            <div className="p-6 space-y-3 s:space-y-4">
              <h1 className="text-xl font-bold text-center leading-tight tracking-tight md:text-2xl text-black">
                로그인
              </h1>
              <div className="space-y-0 s:space-y-2">
                <label 
                  htmlFor="email" 
              ...
              <div className="spcae-y-0 s:space-y-2">
                <label 
                  htmlFor="password" 
                  className="block mb-1 text-s font-medium text-black">
                  비밀번호
              ...
              <button   
                type="submit" 
                className="w-full text-black bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-s px-5 py-1 s:py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                로그인
              </button>
            </div>
          </div>
