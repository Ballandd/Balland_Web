          ...
          <div className = "mt-5 ml-5 mr-5 left-9 top-5">
                <div className = "flex flex-row">
                    ...
                    <div className = "divide-y-2 divide-solid divide-black">
                        <h2 className = " ml-5 left-9 top-5 font-mono text-left text-[20px] font-bold">{props.name}</h2>
                        ...
                        <Icon icon="material-symbols:calendar-today" width="15" />
                            <h2 className = "ml-2 font-mono text-left text-[12px]">{props.period}</h2>
                        </div>                
                        <div className = "flex flex-row mt-3 left-9 top-5 ">
                        <Icon icon="material-symbols:flag-outline-rounded" width="15" />
                            <h2 className = "ml-2 font-mono text-left text-[12px]">{props.part}</h2>
                        </div>
                        <div className = "flex flex-row mt-3 left-9 top-5 ">
                            <Icon icon="material-symbols:location-on" width="15" />
                            <h2 className = "ml-2 font-mono text-left text-[12px]">{props.prize}</h2>
                        </div>
                    </div>
                    </div>
                    </div>
